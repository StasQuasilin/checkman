 ...
 */
@WebServlet(Branches.UI.TRANSPORT_COST)
public class TransportCost extends IModal {

    private static final String _TITLE = "title.reports.transport.cost";
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        req.setAttribute(PRINT, Branches.API.TRANSPORT_COST);
